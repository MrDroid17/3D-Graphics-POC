...
xDisplacement = -5;
yDisplacement = 0;
zDisplacementPositive = 4;
zDisplacementNegative = -4;
...
openBox = () => {
  if (rotZ >= open_rot_z_val) {
    ...
    xDisplacement -= 0.026;
    yDisplacement -= 0.018;
    zDisplacementNegative -= 0.024;
    zDisplacementPositive += 0.024;
    ...
    front_side.rotation.x = - 2.3 * rotZ;
    front_side.position.z = zDisplacementPositive;
    front_side.position.y = yDisplacement;
    
    // front_side.position.y = 1.5;
    back_side.rotation.x = 2.3 * rotZ;
    back_side.position.z = zDisplacementNegative;
    back_side.position.y = yDisplacement;

    left_side.rotation.z = - 2.3 * rotZ;
    left_side.position.x = xDisplacement;
    left_side.position.y = yDisplacement;
